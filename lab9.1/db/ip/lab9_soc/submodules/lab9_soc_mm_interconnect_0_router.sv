...
(
    ...
    localparam PAD11 = log2ceil(64'h2800 - 64'h2000); 
    localparam PAD12 = log2ceil(64'h8001000 - 64'h8000000); 
    ...
    // ( 0x2000 .. 0x2800 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 29'h2000   ) begin
            src_channel = 14'b00000000001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0x8000000 .. 0x8001000 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 29'h8000000   ) begin

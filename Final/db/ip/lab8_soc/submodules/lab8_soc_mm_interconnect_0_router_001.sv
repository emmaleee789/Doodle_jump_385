...
(
    ...
    localparam PAD4 = log2ceil(64'h800000 - 64'h600000); 
    localparam PAD5 = log2ceil(64'ha00000 - 64'h800000); 
    ...
    // ( 0x600000 .. 0x800000 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 29'h600000   ) begin
            src_channel = 15'b0000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 13;
    end

    // ( 0x800000 .. 0xa00000 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 29'h800000   ) begin

...
module nios_system_mm_interconnect_0 (
	...
	wire   [13:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> nios2_qsys_0_debug_mem_slave_agent:cp_channel
	...
	wire   [13:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> sdram_s1_agent:cp_channel
	...
	wire  [106:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> key_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // key_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [13:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> key_s1_agent:cp_channel
	...
	wire   [13:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> otg_hpi_address_s1_agent:cp_channel
	...
	wire   [13:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> keycode_s1_agent:cp_channel
	...
	wire  [106:0] key_s1_agent_rp_data;                                                               // key_s1_agent:rp_data -> router_008:sink_data
	...
	wire   [13:0] rsp_demux_005_src0_channel;                                                         // rsp_demux_005:src0_channel -> crosser_002:in_channel
	...
	wire   [13:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink5_channel
	...
	wire   [13:0] rsp_demux_005_src1_channel;                                                         // rsp_demux_005:src1_channel -> crosser_003:in_channel
	...
	nios_system_mm_interconnect_0_rsp_demux_001 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset

...
(
    ...
    localparam PAD12 = log2ceil(64'h800000 - 64'h600000); 
    localparam PAD13 = log2ceil(64'ha00000 - 64'h800000); 
    ...
    // ( 0x600000 .. 0x800000 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 29'h600000   ) begin
            src_channel = 15'b000000000000100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 13;
    end

    // ( 0x800000 .. 0xa00000 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 29'h800000   ) begin

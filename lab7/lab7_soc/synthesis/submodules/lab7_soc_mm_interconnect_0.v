...
module lab7_soc_mm_interconnect_0 (
	...
	wire  [104:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> nios2_qsys_0_data_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                  // nios2_qsys_0_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [7:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> nios2_qsys_0_data_master_agent:rp_channel
	...
	wire  [104:0] rsp_mux_001_src_data;                                                               // rsp_mux_001:src_data -> nios2_qsys_0_instruction_master_agent:rp_data
	...
	wire  [105:0] nios2_qsys_0_debug_mem_slave_agent_rf_source_data;                                  // nios2_qsys_0_debug_mem_slave_agent:rf_source_data -> nios2_qsys_0_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [105:0] nios2_qsys_0_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios2_qsys_0_debug_mem_slave_agent_rsp_fifo:out_data -> nios2_qsys_0_debug_mem_slave_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> nios2_qsys_0_debug_mem_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // nios2_qsys_0_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [7:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> nios2_qsys_0_debug_mem_slave_agent:cp_channel
	...
	wire    [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> key_s1_agent:cp_channel
	...
	wire  [104:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> sw_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // sw_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> sw_s1_agent:cp_channel
	...
	wire  [104:0] nios2_qsys_0_data_master_agent_cp_data;                                             // nios2_qsys_0_data_master_agent:cp_data -> router:sink_data
	...
	wire  [104:0] nios2_qsys_0_instruction_master_agent_cp_data;                                      // nios2_qsys_0_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [104:0] nios2_qsys_0_debug_mem_slave_agent_rp_data;                                         // nios2_qsys_0_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [104:0] sw_s1_agent_rp_data;                                                                // sw_s1_agent:rp_data -> router_009:sink_data
